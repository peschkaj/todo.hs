...
-- | write the new Event to the Events file if it does not overlap with existing
-- event returns the list of events with the new event at the head on success,
-- or the existing list on failure
